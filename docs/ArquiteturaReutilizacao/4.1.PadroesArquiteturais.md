...
O antigo diagrama de classe pode ser encontrado em:[link da primeira versão do diagrama](https://unbarqdsw2022-2.github.io/2022.2_G3_SpotHood/#/./Modelagem/2.1.1.diagramaDeClasses)
...
1- Servidor: este componente é responsável por armazenar e gerenciar os dados do aplicativo, como informações dos moradores, informações financeiras do condomínio, etc.

2- Banco de dados: este componente é responsável por armazenar e gerenciar os dados do aplicativo, incluindo informações dos moradores, informações financeiras do condomínio, etc.

3- Aplicativo Web: este componente é usado pelos moradores para acessar as funcionalidades do aplicativo, como verificar informações financeiras, reservar áreas comuns, etc.

4- Web API: este componente é responsável por fornecer acesso aos dados do aplicativo a outros sistemas externos, como sistemas de gerenciamento de condomínios ou sistemas de automação residencial.

5- Sistema de Autenticação: este componente é responsável por garantir que apenas os moradores autorizados tenham acesso ao aplicativo.

6- Serviço de Notificação: este componente é responsável por enviar notificações push para os moradores, como lembretes de pagamento, informações de manutenção, etc.

Sistema de Backup: este componente é responsável por fazer cópias de segurança dos dados do aplicativo para garantir a recuperação em caso de falha.
...
O Software está implementado apenas em ambiente de desenvolvimento, ou seja, possuimos um banco de dados, um aplicativo WeB, Servidor (Computadores pessoais), 
 ...
 no qual os contêineres de banco de dados, backend e frontend, são executados e alocados em um só servidor, assim podendo simular a navegação de um usuário pelo navegador.
